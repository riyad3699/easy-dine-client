...
const Pricing = () => {
    return (
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            <div className="text-center mb-10 text-5xl font-bold text-indigo-500"><h1>Membership</h1></div>
            <div
            ...
            >
                ...
                >
                    <div className="p-6 sm:px-8">
                        ...
                        <Link to={'/checkout/silver'}><button
                            className="mt-4 block rounded border border-[#f16667] bg-[#f16667] px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-[#f16667] focus:outline-none focus:ring active:text-indigo-500 sm:mt-6"
                ...
                >
                    <div className="p-6 sm:px-8">
                        ...
                        <Link to={'/checkout/platinum'}><button
                            className="mt-4 block rounded border border-[#f16667] bg-[#f16667] px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-[#f16667] focus:outline-none focus:ring active:text-indigo-500 sm:mt-6"
